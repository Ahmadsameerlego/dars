<template>
    <div>
        <h6 class="black_color fs-20"> الاقسام </h6>
        <div>
            <span> يرجى اضافة أقسام الكلية  </span>
        </div>
    </div>
        ...
        <div class="col-md-8">
            <form action="">
                <div class="form-group position-relative">
                    <label for="" class="fw-bold fs-16"> اضافة قسم </label>
                    <input type="text" v-model="depart_name" class="form-control h-45 border-none" placeholder="اكتب اسم القسم هنا">
            ...
            <div class="mt-4" v-if="departs.length>0">
                <button class="btn main_btn pt-2 pb-2 w-25" @click="$router.push('/config/faculty')"> التالي </button>
            </div>
        </div>
    </div>
